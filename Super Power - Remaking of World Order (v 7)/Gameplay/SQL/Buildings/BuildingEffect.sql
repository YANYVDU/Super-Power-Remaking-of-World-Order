...
insert into Building_DomainEnemyCombatModifierPerGold (BuildingType, DomainType, Modifier)
values ('BUILDING_CITYSTATE_RESOURCE', 'DOMAIN_LAND', -10),
       ('BUILDING_CITYSTATE_RESOURCE', 'DOMAIN_SEA',  -10),
       ('BUILDING_CITYSTATE_RESOURCE', 'DOMAIN_AIR',  -10);