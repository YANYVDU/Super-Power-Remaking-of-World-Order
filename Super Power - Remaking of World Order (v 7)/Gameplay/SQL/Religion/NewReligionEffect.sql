...
SELECT 'BELIEF_SLASH_AND_BURN','FLAVOR_RELIGION',25 UNION ALL
SELECT 'BELIEF_SERENS_GOVERNANCE','FLAVOR_RELIGION',-500 UNION ALL
SELECT 'BELIEF_SAGES_LEGACY','FLAVOR_RELIGION',500 UNION ALL
SELECT 'BELIEF_SAGES_LEGACY','FLAVOR_GREAT_PEOPLE',500 UNION ALL
SELECT 'BELIEF_HOLY_PROPAGATION','FLAVOR_GROWTH',50;
...
INSERT INTO Belief_ImprovementYieldChanges (BeliefType,ImprovementType,YieldType,Yield)
SELECT 'BELIEF_HOLY_PROPAGATION','IMPROVEMENT_FARM','YIELD_FAITH',1;
INSERT INTO Belief_ResourceYieldChanges (BeliefType,ResourceType,YieldType,Yield)
...
INSERT INTO Belief_CorruptionScoreYieldRate (BeliefType,YieldType,Rate)
SELECT 'BELIEF_SERENS_GOVERNANCE','YIELD_FAITH',100;
...
--BELIEF_SAGES_LEGACY
INSERT INTO Belief_AdjacentImprovementYieldChanges (BeliefType,ImprovementType,OtherImprovementType,YieldType,Yield)
SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_ACADEMY',Type,'YIELD_SCIENCE',1 FROM Improvements UNION ALL
SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_CUSTOMS_HOUSE',Type,'YIELD_GOLD',3 FROM Improvements UNION ALL
SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_MANUFACTORY',Type,'YIELD_PRODUCTION',1 FROM Improvements UNION ALL
SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_HOLY_SITE',Type,'YIELD_FAITH',1 FROM Improvements;
CREATE TRIGGER IF NOT EXISTS SP_BeliefAdjacentImprovementYieldChangesForNewImproments
AFTER INSERT ON Improvements
WHEN New.Type != 'IMPROVEMENT_INCA_CITY' AND New.Type NOT LIKE 'IMPROVEMENT_POLYNESIA_CITY_%'
BEGIN
    INSERT INTO Belief_AdjacentImprovementYieldChanges (BeliefType,ImprovementType,OtherImprovementType,YieldType,Yield)
    SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_ACADEMY',New.Type,'YIELD_SCIENCE',1 UNION ALL
    SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_CUSTOMS_HOUSE',New.Type,'YIELD_GOLD',3 UNION ALL
    SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_MANUFACTORY',New.Type,'YIELD_PRODUCTION',1 UNION ALL
    SELECT 'BELIEF_SAGES_LEGACY','IMPROVEMENT_HOLY_SITE',New.Type,'YIELD_FAITH',1;
END;