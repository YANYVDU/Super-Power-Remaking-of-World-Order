...
SELECT 'POLICY_COASTAL_ADMINISTRATION','BUILDINGCLASS_WOOD_DOCK','YIELD_PRODUCTION',2 UNION ALL
SELECT 'POLICY_FAMILY_REGISTER','BUILDINGCLASS_ACADEMY','YIELD_SCIENCE',1;

INSERT INTO Policy_YieldPerGlobalPop (PolicyType, YieldType, YieldModifier)
SELECT 'POLICY_FAMILY_REGISTER','YIELD_SCIENCE',34;
